...
defaultGreen = {0:10, 1:14, 2:10, 3:10}
defaultRed = 150
defaultYellow = 5
...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction):
        ...
        path = "utils/images/" + direction + "/" + vehicleClass + ".png"
...
def driver1(sec,TimeLane) :
    defaultGreen[0] = TimeLane[0]
    defaultGreen[1] = TimeLane[1]
    defaultGreen[2] = TimeLane[2]
    defaultGreen[3] = TimeLane[3]
    
    lane = Cloning(TimeLane)
    ...
    background = pygame.image.load(r'utils/images/intersection.png')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")

    # Loading signal images and font
    redSignal = pygame.image.load(r'utils/images/signals/red.png')
    yellowSignal = pygame.image.load(r'utils/images/signals/yellow.png')
    greenSignal = pygame.image.load(r'utils/images/signals/green.png')
